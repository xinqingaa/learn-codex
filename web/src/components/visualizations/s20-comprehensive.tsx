...
const STAGES: {
  ...
  },
  {
    id: "guardrails",
    label: "Guardrails",
    detail: "approval, sandbox, policy",
...
const STEPS: {
  ...
  },
  {
    ...
    desc: "Approval and sandbox policy are not separate side quests; they are the inspection gate before work happens.",
    stage: "guardrails",
    used: ["intake", "guardrails"],
    packet: {
      request: "Edit files, run build, open browser.",
      carried: ["approval mode", "sandbox verdict", "workspace rules"],
