...
// Step annotations
const STEP_INFO = [
  { title: "The Plan", desc: "update_plan gives the model a visible plan. All tasks start as pending." },
...
export default function PlanTool({ title }: { title?: string }) {
  const {
    currentStep,
    totalSteps,
    next,
