...
const NODES: FlowNode[] = [
  ...
  { id: "api_call", label: "Responses API", x: 160, y: 110, w: 120, h: 40, type: "rect" },
  { id: "check", label: "function_call?", x: 160, y: 200, w: 140, h: 50, type: "diamond" },
...
const EDGES: FlowEdge[] = [
  ...
  { from: "check", to: "execute", label: "function_call" },
  { from: "execute", to: "append" },
  { from: "append", to: "api_call" },
  { from: "check", to: "end", label: "message" },
];
...
const MESSAGES_PER_STEP: (MessageBlock | null)[][] = [
  ...
  [],
  [{ role: "function_call", detail: "read_file(\"auth.ts\")", colorClass: "bg-zinc-600 dark:bg-zinc-500" }],
  [{ role: "function_call_output", detail: "auth.ts contents...", colorClass: "bg-emerald-500 dark:bg-emerald-600" }],
  [
    { role: "function_call", detail: "edit_file(\"auth.ts\")", colorClass: "bg-zinc-600 dark:bg-zinc-500" },
    { role: "function_call_output", detail: "file updated", colorClass: "bg-emerald-500 dark:bg-emerald-600" },
  ],
  [{ role: "message", detail: "Done!", colorClass: "bg-purple-500 dark:bg-purple-600" }],
];

// -- Step annotations --

const STEP_INFO = [
  { title: "The While Loop", desc: "Every agent is a while loop that keeps calling the model until it stops calling tools." },
  { title: "User Input", desc: "The loop starts when the user sends a message." },
  { title: "Call the Model", desc: "Send the input items to the model on the Responses API. It sees everything and decides what to do." },
  { title: "output: function_call", desc: "The model returned a function_call item. The loop continues." },
  { title: "Execute & Append", desc: "Run the tool, append a function_call_output item. Feed it back." },
  { title: "Loop Again", desc: "Same code path, second iteration. The model decides to edit a file." },
  { title: "output: message only", desc: "No function_call left — the model is done. Loop exits. That's the entire agent." },
];
        ...
        <div className="flex flex-col gap-4 lg:flex-row">
          ...
          <div className="w-full lg:w-[60%]">
            <div className="mb-2 font-mono text-xs text-zinc-400 dark:text-zinc-500">
              while (output has function_call)
            </div>
            <svg
              viewBox="0 0 500 440"
