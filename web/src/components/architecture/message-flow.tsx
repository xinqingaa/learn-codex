...
const FLOW_STEPS = [
  ...
  { role: "reasoning", label: "reasoning", color: "bg-zinc-600" },
  { role: "function_call", label: "function_call", color: "bg-amber-500" },
  { role: "function_call_output", label: "function_call_output", color: "bg-emerald-500" },
  { role: "reasoning", label: "reasoning", color: "bg-zinc-600" },
  { role: "function_call", label: "function_call", color: "bg-amber-500" },
  { role: "function_call_output", label: "function_call_output", color: "bg-emerald-500" },
  { role: "message", label: "message (final)", color: "bg-zinc-600" },
];
