...
export const VERSION_META: Record<string, {
  ...
  s19: {
    ...
    keyInsight: "Codex starts MCP from config.toml before the loop; the model only sees mcp__* function tools. This file is also the two child servers.",
    layer: "collaboration",
    prevVersion: "s18",
  },
  s20: {
    ...
    coreAddition: "Three seams on one loop",
    keyInsight: "Part I ends by hanging representatives on three seams around the unchanged s01 loop — not by gluing nineteen demos into one file.",
    layer: "collaboration",
    prevVersion: "s19",
  },
  s21: {
